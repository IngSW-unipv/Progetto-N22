...
public class Home2 extends JFrame {
	...
	public Home2() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(Home2.class.getResource("/it/unipv/po/ticket/gui/home/bar3.png")));
		...
		lblNewLabel_1.setBounds(240, 24, 155, 46);
		homePagePanel.add(lblNewLabel_1);
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setFont(new Font("Calibri", Font.BOLD, 26));
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(Home2.class.getResource("/it/unipv/po/ticket/gui/home/mappaPiccola.png")));
